...
require('../../page/tabBar/component/index');
require('../../page/tabBar/API/index');
...
require('../../page/API/generate-image-from-code/generate-image-from-code');
...
require('../../page/component/cover-view/cover-view');
require('../../page/component/movable-view/movable-view');
...
require('../../page/component/am-icon/am-icon');
require('../../page/component/flex/flex');
require('../../page/component/rich-text/rich-text');
}
